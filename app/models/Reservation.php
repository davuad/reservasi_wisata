...
class Reservation {
    ...
    public function getAllReservation() {
        $query = $this->db->query("SELECT r.reservation_id, u.nama AS user_name, d.nama_destinasi AS destination_name, r.tgl_reservasi, r.status_pembayaran 
                                    FROM reservations r 
                                    JOIN users u ON r.user_id = u.id_users 
                                    JOIN destinations d ON r.destination_id = d.id_destinasi");
